...
| Testing | Jest 29, ts-jest, React Testing Library — 852 tests across 46 suites; 35 Lambda tests (node:test) |
...
- **800** passing automated tests across 44 suites (+ 35 Lambda tests) ensuring allergen safety and filter accuracy
