...
// ─── Ingredient name normalisation (re-exported from ingredient-utils) ────────
// Implementations live in lib/ingredient-utils.ts (no Node.js deps) so they
// can be imported safely by client components as well as server code.

export { MODIFIER_PREFIXES, INGREDIENT_SYNONYMS, normaliseCandidates } from './ingredient-utils'
